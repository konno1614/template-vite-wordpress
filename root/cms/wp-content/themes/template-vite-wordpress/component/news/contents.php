                ...
                <li>
                    <a href="<?php the_permalink(); ?>">
                        <div class="thumbnail">
                            ...
                            <?php else : ?>
                                <picture>
                                    <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/post/dummy.avif" width="900" height="600" alt="dummy" fetchpriority="high" type="image/avif" />
                                    <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/post/dummy.webp" width="900" height="600" alt="dummy" fetchpriority="high" type="image/webp" />
