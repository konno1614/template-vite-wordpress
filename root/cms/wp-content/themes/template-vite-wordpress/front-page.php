                        ...
                        <li>
                            <a href="<?php the_permalink(); ?>">
                                <div class="thumbnail">
                                    ...
                                    <?php else : ?>
                                        <picture>
                                            <source srcset="<?php echo $root; ?>/assets/images/post/dummy02.avif" width="900" height="600" alt="dummy" fetchpriority="high" type="image/avif" />
                                            <source srcset="<?php echo $root; ?>/assets/images/post/dummy02.webp" width="900" height="600" alt="dummy" fetchpriority="high" type="image/webp" />
                                            <img src="<?php echo $root; ?>/assets/images/post/dummy02.jpg" width="900" height="600" alt="dummy" loading="lazy" decoding="async" />
                                        </picture>
                                    <?php endif; ?>
                                </div>
                                <time class="time">
